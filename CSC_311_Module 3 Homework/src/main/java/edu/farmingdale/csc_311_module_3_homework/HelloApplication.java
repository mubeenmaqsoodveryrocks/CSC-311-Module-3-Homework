...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        eMonthlyPayment.setEditable(false);

        //We created a new Label object named TotalPayment for the Total Payment.
        ...
        sCalculate.setOnAction(e -> {
                ...
                eMonthlyPayment.setText(String.format("$%.2f", monthlyPayment));
